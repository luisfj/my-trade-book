...
export default {
    data () {
        return {
            ...
            chartOptions: {
                ...
                height: 250,
                colors: ['yellow', 'green', 'red', 'blue', '#f6c7b6'],
                vAxis: { format: 'currency' }
            },

            periodoSelecionado : 'todos',
            tipoSelecionado    : 'mensal',
            filtroSelecionado  : 'saldo',
            dataInicial        : '',
            dataFinal          : ''
        }
    },
    ...
    methods: {
        atualizarGrafico(){
            ...
            axios.post('/sa/fechamento-mes/grafico/evolucao-saldo', head)
                .then((response) => {
        ...
        formatarRespostaGrafico(dados){
            let res = [];
            this.chartOptions.colors =['yellow', 'green', 'red', 'blue'];
            ...
            switch (this.filtroSelecionado) {
                case 'saldo':
                    this.chartOptions.colors =['blue'];

                    dados.forEach(linha => {
                        res.push(linha.slice(0, 1).concat(linha.slice(4, 5)));
                    });
                    break;
                case 'despesas':
